      ...
      <div className="max-w-4xl mx-auto px-8 py-14">
        ...
        <div className="space-y-5">
          {tickets.map((ticket) => {
            ...
            return (
              <div key={ticket.id} className="bg-surface_container_low rounded-2xl overflow-hidden">
                <div className="grid grid-cols-1 md:grid-cols-4">
                  {/* Event image strip */}
                  <div
                    className="md:col-span-1 h-32 md:h-auto"
                    style={{ background: 'linear-gradient(135deg, #1c1b1b 0%, #252220 100%)' }}
                  >
                    <div className="h-full p-4 flex items-end">
                      <span className={`label-micro ${s.text} flex items-center gap-1.5`}>
